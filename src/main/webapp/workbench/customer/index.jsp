...
<script type="text/javascript">
	$(function(){
		...
		$("#customerBody").on("click",$("input[name=yz]"),function () {
			$("#qx").prop("checked",$("input[name=yz]").length==$("input[name=yz]:checked").length);
		})
	});
		...
		$.ajax({
			...
			success: function (data) {
				...
				$.each(data.dataList, function (i, n) {
					html += '<tr>';
					html += '<td><input type="checkbox" name="yz" value="' + n.id + '" /></td>';
